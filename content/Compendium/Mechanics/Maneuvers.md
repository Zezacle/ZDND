Your experience on the battlefield has refined your fighting techniques. You learn [[Maneuvers]] that are fueled by special dice called Superiority Dice. Maneuvers are used to enhance an attack in some way. You can use only one maneuver per attack.

**Superiority Dice.** Your Superiority Dice are dependent on your class and level. A Superiority Die is expended when you use it. You regain all expended Superiority Dice when you finish a [[Short Rest|Short]] or [[Long Rest]].
...
The target has [[Advantage]] on their saving throw if they are holding what you are trying disarm them of with at least two hands.
...
#### Evasive Footwork
As a Bonus Action, you can expend one Superiority Die and take the [[Disengage]] action. You also roll the die and add the number rolled to your EC until the start of your next turn.
...
#### Rally
As a Bonus Action, you can expend one Superiority Die to bolster the resolve of a companion. Choose an ally of yours within 30 feet of yourself who can see or hear you. That creature gains [[Temporary Hit Points]] equal to the Superiority Die roll plus your proficiency bonus.
