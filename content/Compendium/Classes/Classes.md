...
| [[Warlord]]                               | A warrior that uses intelligence to direct allies in battle.          | Intelligence         | Tactical Playmaking | Military Insight   |
| [[Wizard]]                                | Educated magicians capable of diverse magicks.                        | Intelligence         | Spells (Lots)       | Spellbook          |

### Class Difficulty
Each class has many things to consider when playing them, but some are far easier for others. Below is a simplified measure of a class' "difficulty" based on the complexity and effort required to understand how to be effective with the skills afforded to you.
