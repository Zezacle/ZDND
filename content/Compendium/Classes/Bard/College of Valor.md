...
**Defense.** When the creature is hit by an attack roll, that creature can use its Reaction to roll the Bardic Inspiration die and add the number rolled to its [[Evasion Class|EC]] and [[Armor Class|AC]] against that attack, potentially causing the attack to miss.
...
### Level 6: Honorable Duel

You always have the [[Compelled Duel]] spell prepared. It counts as a Bard spell for you, but doesn't count against the number of spells you know. 
