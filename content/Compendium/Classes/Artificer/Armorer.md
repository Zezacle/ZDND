...
**Dampening Field.** You have [[Advantage]] on [[Stealth]] checks. If the armor imposes [[Disadvantage]] on such checks, the [[Advantage]] and [[Disadvantage]] cancel each other, as normal.
...
Additionally, as a Bonus Action, you can gain a [[Flying|Fly]] Speed equal to twice your [[Speed]] until the end of the current turn. You can take this Bonus Action a number of times equal to your Intelligence modifier (minimum of once), and you regain all expended uses when you finish a [[Long Rest]].