...
As a Bonus Action, you invoke an elven magic called the Bladesong, provided you aren't wearing [[Armor]] or using a [[Shields|Shield]].

The Bladesong lasts for 1 minute and ends early if you have the [[Incapacitated]] condition, if you don [[Armor]] or a [[Shields|Shield]], or if you use two hands to make an attack with a weapon. You can dismiss the Bladesong at any time (no action required).
...
**Agility.** You gain a bonus to your [[Evasion Class]] equal to your Intelligence modifier (minimum of +1), and your [[Speed]] increases by 10 feet. In addition, you have [[Advantage]] on [[Acrobatics]] checks.
