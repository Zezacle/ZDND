...
tags:
  - action
---
This action can be used as an Action or Bonus Action changing it's effectiveness. If an ability says "You can use the [[Dash]] action as a Bonus Action", always use the "As an Action" variant.
