...
The wall is an object that can be damaged and thus breached. It has [[Evasion Class|EC]] 5, [[Armor Class|AC]] 12 and 30 [[Hit Points]] per 10-foot section, and it has [[Immunity]] to Cold, Poison, and Psychic damage and [[Vulnerability]] to Fire damage. Reducing a 10-foot section of wall to 0 [[Hit Points]] destroys it and leaves behind a sheet of frigid air in the space the wall occupied.
