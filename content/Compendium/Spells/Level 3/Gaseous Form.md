...
While in this form, the target's only method of movement is a [[Flying]] Speed of 10 feet, and it can hover. The target can enter and occupy the space of another creature. The target has [[Resistance]] to Bludgeoning, Piercing, and Slashing damage; it has [[Immunity]] to the [[Prone]] condition; and it has [[Advantage]] on Strength, Dexterity, and Constitution saving throws. The target can pass through narrow openings, but it treats liquids as though they were solid surfaces.
