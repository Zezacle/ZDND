...
On the fly, you can create one of the following traps:
- **Snare Trap:** The trapped area will spring vines or ropes on any creature that enters it, [[Grappling]] the creature and reducing their speed to 0. On their next turn, they can attempt Strength saving throw to free themselves.
- **Spike Trap:** The trapped area will spring spikes onto the target, dealing 1d4 piercing damage. This damage increases by 1d4 for each of your character levels.
- **Trigger Trap:** This trap does not have an inherent effect, and instead activates something else. If there is already a trap-like mechanism nearby, you can hook it up to a Trigger Trap.